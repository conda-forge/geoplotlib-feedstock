...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/geoplotlib-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12874&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/geoplotlib-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `geoplotlib` can be installed with:

```
conda install geoplotlib
```

It is possible to list all of the versions of `geoplotlib` available on your platform with:
